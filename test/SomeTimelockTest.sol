...
contract SomeTimelockTest is Test {
    ...
    function test_get_role_member() public {
        ...
        // Order may vary, so just check that both are present
        assertTrue(timelock.getRoleMember(PROPOSER_ROLE, 0) == proposer1 || timelock.getRoleMember(PROPOSER_ROLE, 0) == proposer2);
        assertTrue(timelock.getRoleMember(PROPOSER_ROLE, 1) == proposer1 || timelock.getRoleMember(PROPOSER_ROLE, 1) == proposer2);
    }
